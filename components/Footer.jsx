    ...
    <footer className="text-gray-400 bg-gray-900 body-font">
        <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
            ...
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                <h2 className="title-font font-medium text-white tracking-widest text-sm mb-3">Getting Started</h2>
            ...
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                <h2 className="title-font font-medium text-white tracking-widest text-sm mb-3">Core Concepts</h2>
                <nav className="list-none mb-10">
                <li>
                    <a className="text-gray-400 hover:text-white">First Link</a>
                </li>
            ...
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                <h2 className="title-font font-medium text-white tracking-widest text-sm mb-3">Customization</h2>
                <nav className="list-none mb-10">
                <li>
                    <a className="text-gray-400 hover:text-white">First Link</a>
                </li>
            ...
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                ...
                <li>
                    <a className="text-gray-400 hover:text-white">Discord</a>
                </li>
                <li>
        ...
        <div className="bg-gray-800 bg-opacity-75">
            ...
            <p className="text-gray-400 text-sm text-center sm:text-left">© 2018 NovaGraphix —
                <a href="https://www.youtube.com/@3D-novagraphix" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-100 ml-1" target="_blank">@3D-novagraphix</a>
            </p>
            <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
                ...
                <a className="ml-3 hover:text-gray-100">
                    <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
